...
class NoUnnecessaryCollectionCallRuleTest extends RuleTestCase
{
    protected function getRule(): Rule
    {
        ...
        $modelPropertyExtension = self::getContainer()->getByType(ModelPropertyExtension::class);

        return new NoUnnecessaryCollectionCallRule($reflectionProvider, $modelPropertyExtension, [], []);
    }
    ...
    public function testNoFalseNegativesEloquent(): void
    {
        $this->analyse([__DIR__.'/Data/UnnecessaryCollectionCallsEloquent.php'], [
            ...
            [
                'Called \'isEmpty\' on Laravel collection, but could have been retrieved as a query.',
                57,
            ],
            [
                'Called \'first\' on Laravel collection, but could have been retrieved as a query.',
            ...
            [
                'Called \'where\' on Laravel collection, but could have been retrieved as a query.',
                78,
            ],
            [
            ...
            [
                'Called \'containsStrict\' on Laravel collection, but could have been retrieved as a query.',
                97,
            ],
            [
                'Called \'sum\' on Laravel collection, but could have been retrieved as a query.',
                103,
            ],
        ]);
    }
